"""DEMO VERSION - NOT FULLY FUNCTIONING"""

def intro():
    print("Welcome to the brand new Calculator 2.0 from Hewlet Pacherd. We hope you enjoy this free demo!")
    print("There are many functions that this calculator can do, such as calculate your overall average in school!")
    print("This calculator can also take any two numbers you throw in it, and give you the answers for all operations;")
    print("AT THE SAME TIME!")

#######################################################################################################

def average_calculator_for_school():
    print("This is our setup for calculating your overall average! See if the number it spits out is accurate!")
    #ask all marks and store them
    course1 = input('what is your first courses mark? ')
    course1 = float(course1)
    course2 = input('what is your second courses mark? ')
    course2 = float(course2)
    course3 = input('what is your third courses mark? ')
    course3 = float(course3)
    course4 = input('what is your fourth courses mark? ')
    course4 = float(course4)
    course5 = input('what is your fifth courses mark? ')
    course5 = float(course5)
    course6 = input('what is your sixth courses mark? ')
    course6 = float(course6)
    course7 = input('what is your seventh courses mark? ')
    course7 = float(course7)
    #add all course marks and divide by seven, then print whatever the average is.
    sum = course1 + course2 + course3 + course4 + course5 + course6 + course7
    print('your overall average is')
    average = input(sum / 7)

#######################################################################################################

def multi_calculator():
    print("This is our multi operation calculator! Input any two numbers, and watch it give 6 different answers!")
...
def outro():
    print("This is the end of our demo. Our new Calculator 2.0 will release soon, so stay tuned for more updates!")

    print("A bunch of legal junk is all that's below here, no need to check it out.")
...
DISCLAIMER: THIS IS THE LAGINATOR - IT WILL DESTROY YOUR COMPUTER - WE ASSUME NO RESPONSIBILTY FOR WHAT HAPPENS NEXT
